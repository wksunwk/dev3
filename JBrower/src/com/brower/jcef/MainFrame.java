...
public class MainFrame extends JFrame {
	...
	public static void main(String[] args) {
		// Ìí¼ÓDLL¿â
		MainFrame.addLibraryDir(System.getProperty("user.dir") + "/jcefdll");
		String url = "file://" + System.getProperty("user.dir") + "/html/test.HTML";
		new MainFrame(url, OS.isLinux(), false);
	}
}
